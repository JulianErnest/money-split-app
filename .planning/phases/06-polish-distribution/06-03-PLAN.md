...
<task type="auto">
  <name>Task 2: Convert modals to bottom sheets and add Taglish microcopy</name>
  <files>
    app/(tabs)/index.tsx
    app/group/[id].tsx
    components/groups/AddMemberModal.tsx
...
3. Update `components/groups/AddMemberModal.tsx`:
...
4. Update `app/group/[id].tsx` to use the renamed `AddMemberSheet` with ref pattern:
  ...
  <done>
    ...
    - Peso sign used consistently throughout
...
7. No regressions in create group or add member flows
</verification>
...
- Peso sign visible in relevant contexts
</success_criteria>
